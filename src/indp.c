 ...
 *
 * \brief Functions for INDP footprints.
 *
...
/*!
 * \brief Create an Element for an INDP package.
 *
...
/*!
 * \brief Create a list of known INDP packages.
 *
 ...
 */
GList
indp_create_packages_list ()
{
        GList *indp_packages_list = NULL;
        indp_packages_list = g_list_append (indp_packages_list, "INDP");
        return (*indp_packages_list);
}


/*!
 * \brief Do some Design Rule Checking for the INDP package type.
 *
 * <ul>
 ...
 * <li>check if any fiducials exist.
...
/*!
 * \brief Look up default values for an INDP footprint.
 *
 ...
 */
int
indp_get_default_footprint_values
(
...
/*!
 * \brief Set GUI constraints for an INDP package type.
 *
...
/*!
 * \brief Write a footprint with two pads for an INDP package.
 *
...
/*!
 * \brief A list containing all INDP related functions.
 */
...
indp_function_list[] =
{
#if GUI
        {
                "Set GUI constraints",
                indp_set_gui_constraints,
                "Set GUI constraints for an INDP package",
                NULL
        },
#endif /* GUI */
        {
                "Create Element",
                indp_create_element,
                "Create a pcb element for an INDP package",
                NULL
        },
        {
                "Create Packages List",
                indp_create_packages_list,
                "Create a list of known INDP packages",
                NULL
        },
        {
                "DRC INDP Element",
                indp_drc,
                "Design Rule Check for an INDP package",
                NULL
        },
        {
                "Default Element Values",
                indp_get_default_footprint_values,
                "Get default values for an INDP package",
                NULL
        },
        {
                "Write footprint",
                indp_write_footprint,
                "Write a footprint for an INDP package",
                NULL
        }
};
 ...
 * \brief A list containing all INDP related functions.
 */
REGISTER_FUNCTIONS (indp_function_list)


/*!
 * \brief Initialise by registering all INDP related functions.
 */
void
indp_init ()
{
        register_indp_function_list ();
}
