 ...
 * \brief Functions for RESC SMT footprints.
 *
        ...
        if (!element)
        {
                if (verbose)
                        g_log ("", G_LOG_LEVEL_WARNING,
                                _("could not create a valid element pointer for a ? package."));
                return (NULL);
        }
...
/*!
 * \brief Do some Design Rule Checking for the RESC package type.
 *
 * <ul>
...
#if GUI
/*!
 * \brief Set GUI constraints for the RESC SMT package type.
 *
...
/*!
 * \brief Write a RESC SMT footprint with two pads for a chip package.
 *
...
/*!
 * \brief A list containing all RESC related functions.
 */
...
resc_function_list[] =
{
#if GUI
        {
                ...
                "Set GUI constraints for a RESC SMT package",
                NULL
        },
#endif /* GUI */
        {
                "Create Element",
                resc_create_element,
                "Create a pcb element for a RESC package",
                NULL
        },
        {
        ...
        },
        {
                "DRC RESC Element",
                resc_drc,
                "Design Rule Check for a RESC package",
                NULL
        },
        {
        ...
        },
        {
                "Write footprint",
                resc_write_footprint,
                "Write a footprint for a RESC SMT package",
                NULL
        }
};
 ...
 * \brief A list containing all RESC related functions.
 */
REGISTER_FUNCTIONS (resc_function_list)

/*!
 * \brief Initialise by registering all RESC related functions.
 */
void
resc_init ()
{
        register_resc_function_list ();
}
