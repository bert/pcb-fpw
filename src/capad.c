 ...
 *
 * \brief Functions for CAPAD footprints (Through Hole Capacitor, 
 * Non Polarized, Axial Diameter, Horizontal Mounted).
 *
...
/*!
 * \brief Create a list of known CAPAD packages.
 *
...
/*!
 * \brief Do some Design Rule Checking for the CAPAD package type.
 *
 * <ul>
...
/*!
 * \brief Look up default values for CAPAD footprint.
 *
 ...
 */
int
capad_get_default_footprint_values ()
{
        if (!strcmp (footprint_name, "?CAPAD800W52L600D150"))
        {
                ...
                footprint_name = g_strdup ("CAPAD800W52L600D150");
                return (EXIT_SUCCESS);
        }
        else
        {
...
#if GUI
/*!
 * \brief Set GUI constraints for the CAPAD package type.
 *
...
/*!
 * \brief Write a TH footprint for a CAPAD package.
 *
...
/*!
 * \brief A list containing all CAPAD related functions.
 */
...
capad_function_list[] =
{
#if GUI
        {
                "Set GUI constraints",
                capad_set_gui_constraints,
                "Set GUI constraints for a CAPAD package",
                NULL
        },
#endif /* GUI */
        {
                "Create element",
                capad_create_element,
                "Create an element for a CAPAD package",
                NULL
        },
        {
                "Packages list",
                capad_create_packages_list,
                "Create a list of known CAPAD packages",
                NULL
        },
        {
                "DRC CAPA Element",
                capad_drc,
                "Design Rule Check for a CAPAD package",
                NULL
        },
        {
                "Default Element Values",
                capad_get_default_footprint_values,
                "Get default values for a selected CAPAD package",
                NULL
        },
        {
                "Write footprint",
                capad_write_footprint,
                "Write a footprint for a CAPAD package",
                NULL
        }
};
 ...
 * \brief A list containing all CAPAD related functions.
 */
REGISTER_FUNCTIONS (capad_function_list)
