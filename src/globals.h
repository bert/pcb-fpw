 ...
 *
 * \warning Some pad shape types already defined in pcb.\n
 * These \c #defines are: ROUND, SQUARE and OCTOGONAL.
 */
...
gchar *pad_shape;
        /*!< Shape of pads/pins. */
pad_shapes_t pad_shapes_type = PAD_HAS_NO_SHAPE;
