 ...
 *
 * \brief Functions for JUMP footprints (Through Hole Jumpers).
 *
...
/*!
 * \brief Create an Element for a JUMP package.
 *
...
jump_create_element ()
{
        ...
        {
                /* Now draw a line between the pins if available real estate allows for it. */
...
/*!
 * \brief Create a list of known JUMP packages.
 *
 ...
 */
int
jump_create_packages_list ()
{
        g_list_free (packages_list);
        packages_list = g_list_append (packages_list, "JUMP");
        return (EXIT_SUCCESS);
}


/*!
 * \brief Do some Design Rule Checking for the JUMP package type.
 *
 * <ul>
...
/*!
 * \brief Look up default values for JUMP footprint.
 *
 ...
 */
int
jump_get_default_footprint_values ()
{
        if (!strcmp (footprint_name, "?JUMP"))
        {
...
#if GUI
/*!
 * \brief Set GUI constraints for the JUMP package type.
 *
...
/*!
 * \brief Write a TH footprint for a JUMP package.
 *
...
/*!
 * \brief A list containing all JUMP related functions.
 */
...
jump_function_list[] =
{
#if GUI
        {
                "Set GUI constraints",
                jump_set_gui_constraints,
                "Set GUI constraints for a JUMP package",
                NULL
        },
#endif /* GUI */
        {
                "Create element",
                jump_create_element,
                "Create an element for a JUMP package",
                NULL
        },
        {
                "Packages list",
                jump_create_packages_list,
                "Create a list of known JUMP packages",
                NULL
        },
        {
                "DRC JUMP Element",
                jump_drc,
                "Design Rule Check for a JUMP package",
                NULL
        },
        {
                "Default Element Values",
                jump_get_default_footprint_values,
                "Get default values for a selected JUMP package",
                NULL
        },
        {
                "Write footprint",
                jump_write_footprint,
                "Write a footprint for a JUMP package",
                NULL
        }
};
 ...
 * \brief A list containing all JUMP related functions.
 */
REGISTER_FUNCTIONS (jump_function_list)


/*!
 * \brief Initialise by registering all JUMP related functions.
 */
void
jump_init ()
{
        register_jump_function_list ();
}
