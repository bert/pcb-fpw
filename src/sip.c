 ...
 * \brief Functions for SIP footprints.
 *
...
/*!
 * \brief Create a list of SIP packages with pre-defined values.
 *
...
{
        GList *sip_packages_list = NULL;
        sip_packages_list = g_list_append (sip_packages_list, "SIL");
        return (*sip_packages_list);
}


/*!
 * \brief Do some Design Rule Checking for the SIP package type.
 *
 * <ul>
...
/*!
 * \brief Look up default values for SIP footprints.
 *
...
{
        if (!strcmp (footprint_name, "?SIP04"))
        {
...
/*!
 * \brief Set GUI constraints for the SIP package type.
 *
...
/*!
 * \brief A list containing all SIP related functions.
 */
...
sip_function_list[] =
{
#if GUI
        {
                "Set GUI constraints",
                sip_set_gui_constraints,
                "Set GUI constraints for a SIP package",
                NULL
        },
#endif /* GUI */
        {
        ...
        },
        {
                "DRC SIP Element",
                sip_drc,
                "Design Rule Check for a SIP package",
                NULL
        },
        {
                "Default Element Values",
                sip_get_default_footprint_values,
                "Get default values for a selected SIP package",
                NULL
        },
        {
                "Write footprint",
                sip_write_footprint,
                "Write footprint for a selected SIP package",
                NULL
        }
};
 ...
 * \brief A list containing all SIP related functions.
 */
REGISTER_FUNCTIONS (sip_function_list)


/*!
 * \brief Initialise by registering all SIP related functions.
 */
void
sip_init ()
{
        register_sip_function_list ();
}
