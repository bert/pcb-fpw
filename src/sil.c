 ...
 *
 * \brief Functions for SIL footprints.
 *
...
/*!
 * \brief Create an Element for a SIL package.
 *
...
/*!
 * \brief Create a list of SIL packages with pre-defined values.
 *
 ...
 */
GList
sil_create_packages_list ()
{
        GList *sil_packages_list = NULL;
        sil_packages_list = g_list_append (sil_packages_list, "SIL");
        return (*sil_packages_list);
}


/*!
 * \brief Do some Design Rule Checking for the SIL package type.
 *
 * <ul>
...
/*!
 * \brief Look up default values for SIL footprints.
 *
...
/*!
 * \brief Set GUI constraints for the SIL package type.
 *
...
/*!
 * \brief A list containing all SIL related functions.
 */
...
sil_function_list[] =
{
#if GUI
        {
                "Set GUI constraints",
                sil_set_gui_constraints,
                "Set GUI constraints for a SIL package",
                NULL
        },
#endif /* GUI */
        {
        ...
        },
        {
                "DRC SIL Element",
                sil_drc,
                "Design Rule Check for a SIL package",
                NULL
        },
        {
                "Default Element Values",
                sil_get_default_footprint_values,
                "Get default values for a selected SIL package",
                NULL
        },
        {
                "Write footprint",
                sil_write_footprint,
                "Write footprint for a selected SIL package",
                NULL
        }
};
 ...
 * \brief A list containing all SIL related functions.
 */
REGISTER_FUNCTIONS (sil_function_list)


/*!
 * \brief Initialise by registering all SIL related functions.
 */
void
sil_init ()
{
        register_sil_function_list ();
}
