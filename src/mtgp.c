...
/*!
 * \brief Create an Element for a MTGP package.
 *
...
/*!
 * \brief Create a list of known MTGP packages.
 *
 ...
 */
int
mtgp_create_packages_list ()
{
        g_list_free (packages_list);
        packages_list = g_list_append (packages_list, "MTGP");
        return (EXIT_SUCCESS);
}


/*!
 * \brief Do some Design Rule Checking for the MTGP package type.
 *
 * <ul>
...
/*!
 * \brief Look up default values for MTGP footprint.
 *
 ...
 */
int
mtgp_get_default_footprint_values ()
{
        if (!strcmp (footprint_name, "?MTGP"))
        {
...
#if GUI
/*!
 * \brief Set GUI constraints for the MTGP package type.
 *
...
/*!
 * \brief Write a footprint for a MTGP package.
 *
...
/*!
 * \brief A list containing all MTGP related functions.
 */
...
mtgp_function_list[] =
{
#if GUI
        {
                "Set GUI constraints",
                mtgp_set_gui_constraints,
                "Set GUI constraints for a MTGP package",
                NULL
        },
#endif /* GUI */
        {
                "Create element",
                mtgp_create_element,
                "Create an element for a MTGP package",
                NULL
        },
        {
                "Packages list",
                mtgp_create_packages_list,
                "Create a list of known MTGP packages",
                NULL
        },
        {
                "DRC MTGP Element",
                mtgp_drc,
                "Design Rule Check for a MTGP package",
                NULL
        },
        {
                "Default Element Values",
                mtgp_get_default_footprint_values,
                "Get default values for a selected MTGP package",
                NULL
        },
        {
                "Write footprint",
                mtgp_write_footprint,
                "Write a footprint for a MTGP package",
                NULL
        }
};
 ...
 * \brief A list containing all MTGP related functions.
 */
REGISTER_FUNCTIONS (mtgp_function_list)


/*!
 * \brief Initialise by registering all MTGP related functions.
 */
void
mtgp_init ()
{
        register_mtgp_function_list ();
}
