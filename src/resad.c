 ...
 *
 * \brief Functions for RESAD footprints
...
/*!
 * \brief Create a list of RESAD packages with pre-defined values.
 *
...
resad_create_packages_list ()
{
        ...
        packages_list = g_list_append (packages_list, "RESAD");
        return (EXIT_SUCCESS);
}


/*!
 * \brief Do some Design Rule Checking for the RESAD package type.
 *
 * <ul>
...
/*!
 * \brief Look up default values for RESAD footprint.
 *
 ...
 */
int
resad_get_default_footprint_values ()
{
        if (!strcmp (footprint_name, "?RESAD"))
        {
...
#if GUI
/*!
 * \brief Set GUI constraints for the RESAD package type.
 *
...
/*!
 * \brief Write a TH footprint for a RESAD package.
 *
...
/*!
 * \brief A list containing all RESAD related functions.
 */
...
resad_function_list[] =
{
#if GUI
        {
                "Set GUI constraints",
                resad_set_gui_constraints,
                "Set GUI constraints for a RESAD package",
                NULL
        },
#endif /* GUI */
        {
                "Create element",
                resad_create_element,
                "Create an element for a RESAD package",
                NULL
        },
        {
                "Packages list",
                resad_create_packages_list,
                "Create a list of known RESAD packages",
                NULL
        },
        {
                "DRC ? Element",
                resad_drc,
                "Design Rule Check for a RESAD package",
                NULL
        },
        {
                "Default Element Values",
                resad_get_default_footprint_values,
                "Get default values for a selected RESAD package",
                NULL
        },
        {
                "Write footprint",
                resad_write_footprint,
                "Write a footprint for a RESAD package",
                NULL
        }
};
 ...
 */
REGISTER_FUNCTIONS (resad_function_list)
