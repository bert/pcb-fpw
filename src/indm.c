...
/*!
 * \brief Create an Element for an INDM package.
 *
...
/*!
 * \brief Create a list of known INDM packages.
 *
...
/*!
 * \brief Do some Design Rule Checking for the indm package type.
 *
 * <ul>
...
/*!
 * \brief Look up default values for an INDM footprint.
 *
...
/*!
 * \brief Set GUI constraints for an INDM package type.
 *
...
/*!
 * \brief Write a footprint with two pads for an INDM package.
 *
...
/*!
 * \brief A list containing all INDM related functions.
 */
...
indm_function_list[] =
{
#if GUI
        {
                "Set GUI constraints",
                indm_set_gui_constraints,
                "Set GUI constraints for an INDM package",
                NULL
        },
#endif /* GUI */
        {
                "Create Element",
                indm_create_element,
                "Create a pcb element for an INDM package",
                NULL
        },
        {
                "Create Packages List",
                indm_create_packages_list,
                "Create a list of known INDM packages",
                NULL
        },
        {
                "DRC indm Element",
                indm_drc,
                "Design Rule Check for an INDM package",
                NULL
        },
        {
                "Default Element Values",
                indm_get_default_footprint_values,
                "Get default values for an INDM package",
                NULL
        },
        {
                "Write footprint",
                indm_write_footprint,
                "Write a footprint for an INDM package",
                NULL
        }
};
 ...
 * \brief A list containing all indm related functions.
 */
REGISTER_FUNCTIONS (indm_function_list)


/*!
 * \brief Initialise by registering all indm related functions.
 */
void
indm_init ()
{
        register_indm_function_list ();
}
