/*!
 * \file src/gtk2/filechooser_dialog.c
 *
 * \author Copyright 2007, 2008, 2009, 2010, 2011 by Bert Timmerman <bert.timmerman@xs4all.nl>
 *
 * \brief A filechooser dialog for pcb-gfpw (GTK2 UI).
 *
...
/*!
 * \brief The filechooser dialog "close" signal is emitted.
 *
 * <ul>
 * <li>lookup the dialog widget.
 * <li>destroy the filechooser widget.
 * </ul>
 *
...
/*!
 * \brief The filechooser dialog "current folder changed" signal is emitted.
 *
 * <ul>
 * <li>lookup the dialog widget.
...
/*!
 * \brief The filechooser dialog "Open" button is clicked.
 *
 * <ul>
 * <li>lookup the dialog widget.
...
/*!
 * \brief The filechooser dialog "selection changed" signal is emitted.
 *
...
/*!
 * \brief The filechooser dialog "update preview" signal is emitted.
 *
 * \todo - generate a new preview image.
 * \todo - update the preview widget.
 *
...
create_filechooser_dialog (void)
{
        ...
        filechooser_dialog = gtk_file_chooser_dialog_new
        (
                _("pcb-gfpw: choose a .fpw file"),
                NULL,
        ...
        g_signal_connect
        (
                (gpointer) filechooser_dialog_cancel_button,
                "clicked",
        ...
        g_signal_connect
        (
                (gpointer) filechooser_dialog_open_button,
                "clicked",
