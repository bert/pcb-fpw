/*!
 * \file src/gtk2/main_window.c
 *
 * \author Copyright 2007, 2008, 2009, 2010, 2011 by Bert Timmerman <bert.timmerman@xs4all.nl>
 *
 * \brief Main window for pcb-gfpw (GTK2 UI).
 *
...
/*!
 * \brief Create a main window dialog.
 *
 * <b>Parameters:</b> \c void.\n
 * \n
 * <b>Returns:</b> GtkWidget \c main \c window dialog.
 */
GtkWidget*
create_main_window (void)
{
        ...
        GtkWidget *package_body_width_label;
        ...
        gtk_table_attach
        (
                GTK_TABLE (footprint_tab_table),
                author_frame, 0, 1, 1, 2,
        ...
        gtk_table_attach
        (
                GTK_TABLE (author_table),
                footprint_author_label, 0, 1, 0, 1,
                (GtkAttachOptions) (GTK_FILL),
                (GtkAttachOptions) (0),
                0, 0
        );
        ...
        package_body_width_label = gtk_label_new (_("Body width (Y)"));
        gtk_widget_set_name (package_body_width_label, "pacakge_body_width_label");
        gtk_widget_show (package_body_width_label);
        gtk_table_attach (GTK_TABLE (footprint_table), package_body_width_label, 0, 1, 6, 7,
                (GtkAttachOptions) (GTK_FILL),
                (GtkAttachOptions) (0), 0, 0);
        gtk_misc_set_alignment (GTK_MISC (package_body_width_label), 0, 0.5);
        ...
        GLADE_HOOKUP_OBJECT (pcb_gfpw, package_body_width_label, "pacakge_body_width_label");
