/*!
 * \file src/gtk2/preview_dialog.h
 *
 * \author Copyright (C) 2007, 2008, 2009, 2010, 2011 by Bert Timmerman <bert.timmerman@xs4all.nl>
 *
 * \brief Header file for functions for a footprint preview dialog functions.
 *
...
#ifndef __PREVIEW_DIALOG_INCLUDED__
#define __PREVIEW_DIALOG_INCLUDED__
...
void preview_close_cb (GtkWidget * widget, GtkWidget *preview_window);
gboolean preview_configure_event (GtkWidget *widget, GdkEventConfigure *event);
...
void preview_draw_arc (GtkWidget *widget, preview_arc arc);
void preview_draw_background (GtkWidget *widget, gdouble x, gdouble y);
void preview_draw_line (GtkWidget *widget, preview_line line);
void preview_draw_pad (GtkWidget *widget );
void preview_draw_pin (GtkWidget *widget );
void preview_draw_polygon (GtkWidget *widget, preview_polygon polygon);
void preview_draw_rectangle (GtkWidget *widget, preview_rectangle rectangle);
gboolean preview_expose_event (GtkWidget *widget, GdkEventExpose *event);
int preview_create_window (gchar *footprint_name, gint width, gint height);


#endif /* __PREVIEW_DIALOG_INCLUDED__ */
