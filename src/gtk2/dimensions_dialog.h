/*!
 * \file src/gtk2/dimensions_dialog.h
 *
...
#ifndef __DIMENSIONS_DIALOG_INCLUDED__
#define __DIMENSIONS_DIALOG_INCLUDED__


void dimensions_window_close_cb (GtkWidget *, GtkWidget *);
...
int dimensions_create_window (gchar *);


#endif /* __DIMENSIONS_DIALOG_INCLUDED__ */
