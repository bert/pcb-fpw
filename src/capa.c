...
/*!
 * \brief Create an Element for a CAPA package.
 *
...
/*!
 * \brief Create a list of known CAPA packages.
 *
...
/*!
 * \brief Do some Design Rule Checking for the CAPA package type.
 *
 * <ul>
...
/*!
 * \brief Look up default values for CAPA footprint.
 *
        ...
        gchar *footprint_name)
{
        if (!strcmp (footprint_name, "?CAPA770-380X250"))
        {
                ...
                footprint_name = g_strdup ("CAPA770-380X250");
                return (EXIT_SUCCESS);
        }
        else
        {
...
#if GUI
/*!
 * \brief Set GUI constraints for the CAPA package type.
 *
 ...
 */
int
capa_set_gui_constraints (GtkWidget *widget)
{
...
/*!
 * \brief Write a TH footprint for a CAPA package.
 *
...
/*!
 * \brief A list containing all CAPA related functions.
 */
...
capa_function_list[] =
{
#if GUI
        {
                ...
                "Set GUI constraints for a CAPA package",
                NULL
        },
#endif /* GUI */
        {
                "Create element",
                capa_create_element,
                "Create an element for a CAPA package",
                NULL
        },
        {
                "Packages list",
                capa_create_packages_list,
                "Create a list of known CAPA packages",
                NULL
        },
        {
                "DRC CAPA Element",
                capa_drc,
                "Design Rule Check for a CAPA package",
                NULL
        },
        {
                "Default Element Values",
                capa_get_default_footprint_values,
                "Get default values for a selected CAPA package",
                NULL
        },
        {
                "Write footprint",
                capa_write_footprint,
                "Write a footprint for a CAPA package",
                NULL
        }
};
 ...
 * \brief A list containing all CAPA related functions.
 */
REGISTER_FUNCTIONS (capa_function_list)


/*!
 * \brief Initialise by registering all CAPA related functions.
 */
void
capa_init ()
{
        register_capa_function_list ();
}
