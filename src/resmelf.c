 ...
 *
 * \brief Functions for RESMELF footprints.
 *
...
/*!
 * \brief Create a list of known RESMELF packages.
 *
 ...
 */
GList
resmelf_create_packages_list ()
{
        GList *resmelf_packages_list = NULL;
        resmelf_packages_list = g_list_append (resmelf_packages_list, "RESMELF");
        return (*resmelf_packages_list);
}


/*!
 * \brief Do some Design Rule Checking for the RESMELF package type.
 *
 * <ul>
...
/*!
 * \brief Look up default values for a RESMELF footprint.
 *
...
)
{
        if (!strcmp (footprint_name, "?RESMELF"))
        {
                ...
                footprint_name = g_strdup ("RESMELF");
                return (EXIT_SUCCESS);
        }
        else
        {
...
/*!
 * \brief Set GUI constraints for a RESMELF package type.
 *
...
/*!
 * \brief Write a footprint with two pads for a RESMELF package.
 *
...
resmelf_function_list[] =
{
#if GUI
        {
                "Set GUI constraints",
                resmelf_set_gui_constraints,
                "Set GUI constraints for a RESMELF package",
                NULL
        },
#endif /* GUI */
        {
                "Create Element",
                resmelf_create_element,
                "Create a pcb element for a RESMELF package",
                NULL
        },
        {
                "Create Packages List",
                resmelf_create_packages_list,
                "Create a list of known RESMELF packages",
                NULL
        },
        {
                "DRC Element",
                resmelf_drc,
                "Design Rule Check for a RESMELF package",
                NULL
        },
        {
                "Default Element Values",
                resmelf_get_default_footprint_values,
                "Get default values for a RESMELF package",
                NULL
        },
        {
                "Write footprint",
                resmelf_write_footprint,
                "Write a footprint for a RESMELF package",
                NULL
        }
};
...
/*!
 * \brief A list containing all RESMELF related functions.
 */
REGISTER_FUNCTIONS (resmelf_function_list)


/*!
 * \brief Initialise by registering all RESMELF related functions.
 */
void
resmelf_init ()
{
        register_resmelf_function_list ();
}
