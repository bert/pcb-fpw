 ...
 *
 * \brief Functions for RESAR footprints
...
/*!
 * \brief Create a list of RESAR packages with pre-defined values.
 *
...
resar_create_packages_list ()
{
        ...
        packages_list = g_list_append (packages_list, "RESAR");
        return (EXIT_SUCCESS);
}


/*!
 * \brief Do some Design Rule Checking for the RESAR package type.
 *
 * <ul>
...
/*!
 * \brief Look up default values for RESAR footprint.
 *
 ...
 */
int
resar_get_default_footprint_values ()
{
        if (!strcmp (footprint_name, "?RESAR"))
        {
...
#if GUI
/*!
 * \brief Set GUI constraints for the RESAR package type.
 *
...
/*!
 * \brief Write a TH footprint for a RESAR package.
 *
...
/*!
 * \brief A list containing all RESAR related functions.
 */
...
resar_function_list[] =
{
#if GUI
        {
                "Set GUI constraints",
                resar_set_gui_constraints,
                "Set GUI constraints for a RESAR package",
                NULL
        },
#endif /* GUI */
        {
                "Create element",
                resar_create_element,
                "Create an element for a RESAR package",
                NULL
        },
        {
                "Packages list",
                resar_create_packages_list,
                "Create a list of known RESAR packages",
                NULL
        },
        {
                "DRC ? Element",
                resar_drc,
                "Design Rule Check for a RESAR package",
                NULL
        },
        {
                "Default Element Values",
                resar_get_default_footprint_values,
                "Get default values for a selected RESAR package",
                NULL
        },
        {
                "Write footprint",
                resar_write_footprint,
                "Write a footprint for a RESAR package",
                NULL
        }
};
 ...
 */
REGISTER_FUNCTIONS (resar_function_list)
