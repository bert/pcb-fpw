...
main (int argc, char *argv[])
{
        ...
        gFootprintWizard = create_gFootprintWizard ();
        ...
        C1_entry = lookup_widget (GTK_WIDGET (gFootprintWizard), "C1_entry");
        C2_entry = lookup_widget (GTK_WIDGET (gFootprintWizard), "C2_entry");
        G1_entry = lookup_widget (GTK_WIDGET (gFootprintWizard), "G1_entry");
        G2_entry = lookup_widget (GTK_WIDGET (gFootprintWizard), "G2_entry");
        Z1_entry = lookup_widget (GTK_WIDGET (gFootprintWizard), "Z1_entry");
        Z2_entry = lookup_widget (GTK_WIDGET (gFootprintWizard), "Z2_entry");
        ...
        thermal = lookup_widget (GTK_WIDGET (gFootprintWizard), "thermal_checkbutton");
        thermal_length_entry = lookup_widget (GTK_WIDGET (gFootprintWizard), "thermal_length_entry");
        thermal_width_entry = lookup_widget (GTK_WIDGET (gFootprintWizard), "thermal_width_entry");
        thermal_solder_mask_clearance_entry = lookup_widget (GTK_WIDGET (gFootprintWizard), "thermal_solder_mask_clearance_entry");
        ...
        gtk_widget_show (gFootprintWizard);
